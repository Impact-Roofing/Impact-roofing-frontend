...
export default function Hero() {
    return (
        ...
        <ArrowIcon />
            ...
            {/* Badge "100% Happy customers" — esquina inferior derecha (Oculto en mobile, visible desde lg) */}
            <div className="hidden lg:flex absolute bottom-4 right-6 z-20 lg:bottom-60 lg:right-20">
